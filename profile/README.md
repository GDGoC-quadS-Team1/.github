...
**MORETALE**은 다문화 가정의 부모와 아이가 함께 이야기를 만들며
...
> 각 가정의 언어와 문화적 특성을 반영한 맞춤형 동화를 생성하고, 
> <br> 동화 속 단어 학습, 퀴즈, 음성(TTS) 기능을 하나의 경험으로 연결하여 지속적인 언어 학습을 지원합니다.
...
<div align="center">
  <img src="assets/Architecture.png" width="75%" alt="Vocabulary Learning"/>
</div>
...
> 아동 친화적인 경험을 위해 가독성과 직관성을 우선시했으며, 
> <br>서비스의 아이덴티티인 꿀벌 캐릭터를 중심으로 따뜻하고 친근한 브랜드 경험을 설계했습니다.
